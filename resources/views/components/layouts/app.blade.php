            ...
            <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
                ...
                <a href="index.html">
                    ...
                    <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                        src="/assets/src/images/logo/logo-icon.svg" alt="Logo" />
                </a>
            </div>
            <!-- SIDEBAR HEADER -->
                            ...
                            <li>
                                ...
                                <div class="overflow-hidden transform translate"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                        <li>
                                            <a href="/assets/alerts.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="/assets/avatars.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="/assets/badge.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="/assets/buttons.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="/assets/images.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="/assets/videos.html" class="menu-dropdown-item group"
                ...
                <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
                    <div
                        ...
                        <a href="index.html" class="lg:hidden">
                            <img class="dark:hidden" src="/assets/src/images/logo/logo.svg" alt="Logo" />
                            <img class="hidden dark:block" src="/assets/src/images/logo/logo-dark.svg"
                                alt="Logo" />
                        </a>
                        ...
                        <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                            <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                                ...
                                <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                                    <img src="/assets/src/images/user/owner.jpg" alt="User" />
                                </span>
