                                        ...
                                        <div class="flex items-center">
                                            <div class="flex items-center gap-3">
                                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                    <img src="/assets/src/images/product/product-01.jpg"
                                                        alt="Product" />
                                                </div>
                                                <div>
                                                    <p
                                ...
                                <tr>
                                    <td class="py-3">
                                        <div class="flex items-center">
                                            <div class="flex items-center gap-3">
                                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                    <img src="/assets/src/images/product/product-02.jpg"
                                                        alt="Product" />
                                                </div>
                                                <div>
                                                    <p
                                ...
                                <tr>
                                    <td class="py-3">
                                        <div class="flex items-center">
                                            <div class="flex items-center gap-3">
                                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                    <img src="/assets/src/images/product/product-03.jpg"
                                                        alt="Product" />
                                                </div>
                                                <div>
                                                    <p
                                ...
                                <tr>
                                    <td class="py-3">
                                        <div class="flex items-center">
                                            <div class="flex items-center gap-3">
                                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                    <img src="/assets/src/images/product/product-04.jpg"
                                                        alt="Product" />
                                                </div>
                                                <div>
                                                    <p
                                ...
                                <tr>
                                    <td class="py-3">
                                        <div class="flex items-center">
                                            <div class="flex items-center gap-3">
                                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                    <img src="/assets/src/images/product/product-05.jpg"
                                                        alt="Product" />
                                                </div>
                                                <div>
                                                    <p
